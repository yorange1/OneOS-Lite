...
#define SH_FUNCTION_EXPORT_CMD(func, cmd, desc)                                                                        \
    ...
    OS_USED const sh_cmd_entry_t __fsym_##cmd OS_SECTION(                                                              \
        "FSymTab") = {__fsym_##cmd##_name, __fsym_##cmd##_desc, (sh_cmd_func_t)func};
#else
#define SH_FUNCTION_EXPORT_CMD(func, cmd, desc)                                                                        \
    const char __fsym_##cmd##_name[] = #cmd;                                                                           \
    OS_USED const sh_cmd_entry_t __fsym_##cmd OS_SECTION("FSymTab") = {__fsym_##cmd##_name, (sh_cmd_func_t)func};
