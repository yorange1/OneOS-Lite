...
#define netconn_sendto(netconn, addr, port, data, size)                                                                \
    mo_netconn_sendto(mo_get_default(), netconn, addr, port, data, size)
#define netconn_recvfrom(netconn, data, size, addr, port, timeout)                                                     \
    mo_netconn_recvfrom(mo_get_default(), netconn, data, size, addr, port, timeout)
...
#define netconn_recv(netconn, data, size, timeout)                                                                     \
    mo_netconn_recvfrom(mo_get_default(), netconn, data, size, OS_NULL, OS_NULL, timeout)
...
#define onenetnb_create(timeout, resp, format, ...)                                                                    \
    mo_onenetnb_create(mo_get_default(), timeout, resp, format, __VA_ARGS__)
#define onenetnb_createex(timeout, resp, format, ...)                                                                  \
    mo_onenetnb_createex(mo_get_default(), timeout, resp, format, __VA_ARGS__)
#define onenetnb_delete(timeout, resp, format, ...)                                                                    \
    mo_onenetnb_delete(mo_get_default(), timeout, resp, format, __VA_ARGS__)
#define onenetnb_addobj(timeout, resp, format, ...)                                                                    \
    mo_onenetnb_addobj(mo_get_default(), timeout, resp, format, __VA_ARGS__)
#define onenetnb_delobj(timeout, resp, format, ...)                                                                    \
    mo_onenetnb_delobj(mo_get_default(), timeout, resp, format, __VA_ARGS__)
...
#define onenetnb_close(timeout, resp, format, ...)                                                                     \
    mo_onenetnb_close(mo_get_default(), timeout, resp, format, __VA_ARGS__)
#define onenetnb_readrsp(timeout, resp, format, ...)                                                                   \
    mo_onenetnb_readrsp(mo_get_default(), timeout, resp, format, __VA_ARGS__)
#define onenetnb_writersp(timeout, resp, format, ...)                                                                  \
    mo_onenetnb_writersp(mo_get_default(), timeout, resp, format, __VA_ARGS__)
#define onenetnb_notify(timeout, resp, format, ...)                                                                    \
    mo_onenetnb_notify(mo_get_default(), timeout, resp, format, __VA_ARGS__)
#define onenetnb_update(timeout, resp, format, ...)                                                                    \
    mo_onenetnb_update(mo_get_default(), timeout, resp, format, __VA_ARGS__)
