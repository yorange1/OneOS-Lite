...
int mo_socket(int domain, int type, int protocol)
{
 ...
 */
#if defined(MOLINK_USING_SINGLE_MODULE)
int mo_bind(int socket, const struct sockaddr *name, socklen_t namelen)
{
    mo_object_t *module = mo_object_get();
#elif defined(MOLINK_USING_MULTI_MODULES)
 ...
 */
#if defined(MOLINK_USING_SINGLE_MODULE)
int mo_bind_with_cb(int socket, const struct sockaddr *name, socklen_t namelen, mo_netconn_data_callback cb)
{
    mo_object_t *module = mo_object_get();
#elif defined(MOLINK_USING_MULTI_MODULES)
...
int mo_send(int socket, const void *data, size_t size, int flags)
{
    ...
    return mo_sendto(socket, data, size, flags, OS_NULL, 0);
}
#elif defined(MOLINK_USING_MULTI_MODULES)
 ...
 */
#if defined(MOLINK_USING_SINGLE_MODULE)
int mo_recv(int socket, void *mem, size_t len, int flags)
{
    OS_ASSERT(mem != OS_NULL);

    return mo_recvfrom(socket, mem, len, flags, OS_NULL, OS_NULL);
}
#elif defined(MOLINK_USING_MULTI_MODULES)
 ...
 */
#if defined(MOLINK_USING_SINGLE_MODULE)
int mo_getsockopt(int socket, int level, int optname, void *optval, socklen_t *optlen)
{
    mo_object_t *module = mo_object_get();
#elif defined(MOLINK_USING_MULTI_MODULES)
 ...
 */
#if defined(MOLINK_USING_SINGLE_MODULE)
int mo_setsockopt(int socket, int level, int optname, const void *optval, socklen_t optlen)
{
    mo_object_t *module = mo_object_get();
#elif defined(MOLINK_USING_MULTI_MODULES)
 ...
 */
#if defined(MOLINK_USING_SINGLE_MODULE)
struct hostent *mo_gethostbyname(const char *name)
{
    mo_object_t *module = mo_object_get();
#elif defined(MOLINK_USING_MULTI_MODULES)
