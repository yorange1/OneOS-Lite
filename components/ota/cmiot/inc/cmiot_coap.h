...
#define STR_COAP_CODE(code)                                                                                                                                         \
    ((code) == COAP_201_CREATED                                                                                                                                     \
         ? "COAP_201"                                                                                                                                               \
         : ((code) == COAP_202_DELETED                                                                                                                              \
                ? "COAP_202"                                                                                                                                        \
                : ((code) == COAP_204_CHANGED                                                                                                                       \
                       ? "COAP_204"                                                                                                                                 \
                       : ((code) == COAP_205_CONTENT                                                                                                                \
                              ? "COAP_205"                                                                                                                          \
                              : ((code) == COAP_206_CONFORM                                                                                                         \
                                     ? "COAP_206"                                                                                                                   \
                                     : ((code) == COAP_231_CONTINUE                                                                                                 \
                                            ? "COAP_231"                                                                                                            \
                                            : ((code) == COAP_400_BAD_REQUEST                                                                                       \
                                                   ? "COAP_400"                                                                                                     \
                                                   : ((code) == COAP_401_UNAUTHORIZED                                                                               \
                                                          ? "COAP_401"                                                                                              \
                                                          : ((code) == COAP_402_BAD_OPTION                                                                          \
                                                                 ? "COAP_402"                                                                                       \
                                                                 : ((code) == COAP_404_NOT_FOUND                                                                    \
                                                                        ? "COAP_404"                                                                                \
                                                                        : ((code) == COAP_405_METHOD_NOT_ALLOWED                                                    \
                                                                               ? "COAP_405"                                                                         \
                                                                               : ((code) == COAP_406_NOT_ACCEPTABLE                                                 \
                                                                                      ? "COAP_406"                                                                  \
                                                                                      : ((code) ==                                                                  \
                                                                                                    ...
                                                                                                    : ((code) ==                                                    \
                                                                                                           ...
                                                                                                           : ((code) ==                                             \
                                                                                                                  ...
                                                                                                                  : ((code) ==                                      \
                                                                                                                         ...
                                                                                                                         ? "COAP_503"                               \
                                                                                                                         : ((code) ==                               \
                                                                                                                                    COAP_505_PROXYING_NOT_SUPPORTED \
                                                                                                                                ? "COAP_505"                        \
                                                                                                                                : "Unknown"))))))))))))))))))
