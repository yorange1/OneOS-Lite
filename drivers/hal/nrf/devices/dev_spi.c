...
#define BSP_SPI1_SS_PIN   17
#endif

#ifdef BSP_USING_SPI1
struct nrf5_spi_info spi1_info = {NRFX_SPI_INSTANCE(1),BSP_SPI1_MISO_PIN,BSP_SPI1_MOSI_PIN,BSP_SPI1_SCK_PIN,BSP_SPI1_SS_PIN};
