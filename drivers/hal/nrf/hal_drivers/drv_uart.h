...
#define EVAL_COM2_TX_PIN                 8
#define EVAL_COM2_RX_PIN                 7
#define EVAL_COM2_PARITY                 _PRIO_APP_LOWEST
#define EVAL_COM2_RTS_PIN                 9
#define EVAL_COM2_CTS_PIN                 10
#define EVAL_COM2_FLOW_CTR                 APP_UART_FLOW_CONTROL_DISABLED

#define EVAL_COM3                        3
#define EVAL_COM3_BAUDRATE               115200
#define EVAL_COM3_TX_PIN                 3
#define EVAL_COM3_RX_PIN                 2
#define EVAL_COM3_PARITY                 _PRIO_APP_LOWEST
#define EVAL_COM3_RTS_PIN                 9
#define EVAL_COM3_CTS_PIN                 10
#define EVAL_COM3_FLOW_CTR                 APP_UART_FLOW_CONTROL_DISABLED
