...
def gen_hc32_link_file_keil(prj_path, app_addr, app_size, ram_addr, ram_size):
...
def gen_hc32_link_file(prj_path):
    ...
    gen_hc32_link_file_keil(prj_path, app_addr, app_size, ram_addr, ram_size)    

def prebuild(prj_path):
    print("project " + prj_path)
    gen_hc32_link_file(prj_path)
