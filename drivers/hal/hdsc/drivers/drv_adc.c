...
#if (HC32_ADC_MAX_CHANNEL >= 4)
        {GpioPortA, GpioPin3, AdcSQRCH3MUX, AdcExInputCH3},
#if (HC32_ADC_MAX_CHANNEL >= 5)
        {GpioPortA, GpioPin4, AdcSQRCH4MUX, AdcExInputCH4},
#if (HC32_ADC_MAX_CHANNEL >= 6)
        {GpioPortA, GpioPin5, AdcSQRCH5MUX, AdcExInputCH5},
#endif
#endif
#endif
#endif
...
int os_hw_adc_init(void)
{
    ...
    result = os_hw_adc_register(dev_adc, "adc", NULL);
