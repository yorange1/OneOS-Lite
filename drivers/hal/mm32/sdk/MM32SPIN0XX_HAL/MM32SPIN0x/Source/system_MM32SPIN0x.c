...
*                      the "system_MM32SPIN0x_KEIL.s" file.
*
...
*    Then SystemInit() function is called, in "system_MM32SPIN0x_KEIL.s" file, to
...
*    the product used), refer to "HSE_VALUE" define in "MM32SPIN0x.h" file. 
