...
def gen_mm32_link_file_keil(prj_path, app_addr, app_size, ram_addr, ram_size):
...
def gen_mm32_link_file(prj_path):
    ...
    gen_mm32_link_file_keil(prj_path, app_addr, app_size, ram_addr, ram_size)
    
def prebuild(prj_path, bsp_path = '/board/CubeMX_Config/Src/'):
    print("project " + prj_path)
    gen_mm32_link_file(prj_path)
