...
#define HK32_TIM_IRQHandler_DEFINE(__index) \
void TIM##__index##_IRQHandler(void)        \
{                                           \
    TIMn_IRQHandler(TIM##__index);          \
}

HK32_TIM_IRQHandler_DEFINE(2);
HK32_TIM_IRQHandler_DEFINE(3);
HK32_TIM_IRQHandler_DEFINE(4);
HK32_TIM_IRQHandler_DEFINE(6);
