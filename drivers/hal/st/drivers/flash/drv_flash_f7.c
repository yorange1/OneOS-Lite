...
#define ADDR_FLASH_SECTOR_0 ((os_uint32_t)0x08000000) /* Base @ of Sector 0, 16 Kbytes */
#define ADDR_FLASH_SECTOR_1 ((os_uint32_t)0x08004000) /* Base @ of Sector 1, 16 Kbytes */
#define ADDR_FLASH_SECTOR_3 ((os_uint32_t)0x08008000) /* Base @ of Sector 0, 16 Kbytes */
#define ADDR_FLASH_SECTOR_4 ((os_uint32_t)0x0800C000) /* Base @ of Sector 1, 16 Kbytes */
...
static os_uint32_t GetSector(os_uint32_t Address)
{
    ...
    else if ((Address < STM32_FLASH_END_ADDRESS) && (Address >= ADDR_FLASH_SECTOR_4))
#else
    else if ((Address < ADDR_FLASH_SECTOR_5) && (Address >= ADDR_FLASH_SECTOR_4))
#endif
    {
...
int stm32_flash_write(os_uint32_t addr, const os_uint8_t *buf, size_t size)
{
    ...
    {
        /* write data to flash */
        if (HAL_FLASH_Program(FLASH_TYPEPROGRAM_BYTE, addr, (os_uint64_t)(*buf)) == HAL_OK)
        {
